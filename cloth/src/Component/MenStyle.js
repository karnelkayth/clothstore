...
import MenStylefashion from '../API/MenStyle'
...
const MenStyle = () => {
    const [MenStyles, SetMenStyles] = useState(MenStylefashion)
        ...
        <div id='top-section'>
            <div id='mini-product-section'>
                ...
                <div id='wrapper-product-section'>
                    <h1 id='titlle'>MEN CASUAL STYLE</h1>
                    ...
                    <div id='top-main-product-section'>
                        {
                            MenStyles.map((Product, index) => {
                                return (
                                    <div id='popular-product-boxx' onClick={()=>handleproduct(Product)}>
