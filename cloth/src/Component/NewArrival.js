...
import newarrivalfashion from '../API/NewArrival'
...
const NewArrival = () => {
    const [NewArrivals, SetNewArrival] = useState(newarrivalfashion)
            ...
            <div id='mini-product-section'>
                ...
                <div id='wrapper-product-section'>
                    ...
                    <div id='top-main-product-section'>
                        {
                            newarrivalfashion.map((Product, index) => {
                                return (
